...
class TranscriptTestGetPassedCourses(unittest.TestCase):
    ...
    def testGetPassedCourses(self):
        ...
        passedCourseGrades = transcript.acquirePassedCourses()
        testCoursesPassed = list(map(lambda x: x.getCourse(), passedCourseGrades))
        self.assertFalse(course1 in testCoursesPassed, "Passed courses should not contain course1")
        self.assertTrue(course2 in testCoursesPassed, "Passed courses should contain course2")
        self.assertTrue(course3 in testCoursesPassed, "Passed courses should contain course3")
